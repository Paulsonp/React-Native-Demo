...
app.get('/employee', (req, res) => {
  res.json([
    ...
    {id: 8, image: 'square.png', rating: 5, name: 'lenin jayaraj', place: 'edukki'},
    {id: 9, image: 'square.png', rating: 5, name: 'chandulal', place: 'trivandrum'},
    {id: 10, image: 'square.png', rating: 5, name: 'sneha', place: 'kannur'},
    {id: 11, image: 'square.png', rating: 5, name: 'paulson ps', place: 'trivandrum'},
    ...
    {id: 20, image: 'triangle.png', rating: 5, name: 'vignesh', place: 'trivandrum'},
    {id: 21, image: 'triangle.png', rating: 5, name: 'abilash anandhan', place: 'trivandrum'},
    {id: 22, image: 'triangle.png', rating: 5, name: 'vinay', place: 'trivandrum'},
